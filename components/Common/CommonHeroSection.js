...
export default function AboutHeroSection({subHeadingText, mainHeadingText, detailsText}) {
        ...
        <div className='container w-full items-center mx-auto'>
            <div className='flex flex-wrap justify-between align-middle w-full my-8 md:my-20'>
                <div className='flex flex-col align-middle justify-center w-full lg:w-[50%] mt-10 md:mt-0'>
                    <p className='text-white text-lg font-normal text-start uppercase font-poppins'>{t(subHeadingText)}</p>
