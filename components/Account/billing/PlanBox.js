  ...
  return (
    ...
    >
      <div className="border-b-[2px] border-gray-300 py-2">
        <h5 className="text-dark-blue-2 text-lg font-semibold py-2">Plan</h5>
        <p className="text-dark-blue-2 text-md opacity-70 pb-2 pt-1">
          Your Personal account is on the <span> Hobby </span> plan. Free of
          charge. <span>Learn more → </span>
        </p>
      </div>
