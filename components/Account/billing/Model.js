              ...
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  sm:max-w-lg sm:w-full">
                ...
                <div className="bg-white px-5 py-3 ">
                  <p className="text-sm font-light text-justify  text-dark-blue-2">
                    Collaborate with others and take advantage of increased
                    build concurrency, performance analytics, security features,
                    and more. To get started, name your new Vercel team:
                  </p>
                </div>
                <div className="bg-white px-5  py-3">
                  <label
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  xs:w-[95%] sm:w-[340px] lg:w-[400px] md:w-[350px]">
                ...
                <div className="px-5 pt-2 pb-12 relative">
                   <input className="w-full my-1 rounded-md border-dark-blue-2 border-[1px] py-1.5 px-2 text-sm mb-1 focus:ring-4 focus:ring-gray-200 transition duration-200 focus:outline-none text-dark-blue-2" type={'text'} placeholder="my-external-domain.com"/>
                   ...
                   <input className="w-full my-1 rounded-md pr-10 border-dark-blue-2 border-[1px] py-1.5 px-2 text-sm mb-1 focus:ring-4 focus:ring-gray-200 transition duration-200 focus:outline-none text-dark-blue-2" type={'text'} placeholder="my-external-domain.com"/>
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  xs:w-[95%] sm:w-[400px] lg:w-[500px] md:w-[420px]">
                ...
                <div className="px-5 py-2">
                  ...
                  Vercel will delete all of your projects, along with all of your deployments, domains, SSL certificates, activity, and all other resources belonging to your Personal Account.
                  </p>
                  <p className="text-sm text-dark-blue-2 opacity-80 text-center mt-5">
                  Vercel recommends that you remove Vercel Nameservers from all of your domains.
                  </p>

                   <div className="mx-auto py-2 bg-red-500 my-4 rounded-md ">
                      <p className="text-center text-sm text-white font-medium">This action is not reversible. Please be certain.</p>
                   </div>
                </div>
                ...
                <div className="bg-white px-2  py-3">
                  <label
                    ...
                    className="block mb-2 text-sm font-medium text-dark-blue-2 opacity-80 "
                  >
                    Enter your username random-1120 to continue:
                  </label>
                  <input
                    type="text"
                    id="username"
                ...
                <div className="bg-white px-2  py-3">
                  <label
                    ...
                    className="block mb-2 text-sm font-medium text-dark-blue-2 opacity-80 "
                  >
                    To verify, type delete my personal account below:
                  </label>
                  <input
                    type="text"
                    id="verify"
...
export function AddIntegerationModel({ state, setstate }) {
          ...
          <div className="flex items-end sm:items-center justify-center min-h-full p-4  sm:p-0">
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  xs:w-[95%] sm:w-[400px] lg:w-[500px] md:w-[420px]">
                ...
                <div className="border-t-[1px] border-gray-400 py-2 px-2">
                    <p className="p-[12px] text-sm text-dark-blue-2 opacity-80">Select a Vercel Account to add the Integration to:</p>
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  xs:w-[95%] sm:w-[400px] lg:w-[500px] md:w-[420px]">
                <div className="bg-white px-4 py-8 sm:p-6 sm:pb-4 border-b-[1px] border-gray-200">
                  ...
                  <h2 className="text-xl font-medium text-center  text-dark-blue-2 py-1">Move Domain</h2>
                  <p className="text-sm text-center  text-dark-blue-2 opacity-80 py-2">When moving the following Domain, it will be removed from all of the projects it is currently used in.</p>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-sm text-start  text-dark-blue-2 opacity-80 py-2 mt-3">The following Domain will be moved and any aliases that are not associated with a project domain will be removed immediately.</p>
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  xs:w-[95%] sm:w-[400px] lg:w-[460px] md:w-[420px]">
                <div className="bg-white px-4 py-8 sm:p-6 sm:pb-4 border-b-[1px] border-gray-200">
                  ...
                  <h2 className="text-xl font-medium text-center  text-dark-blue-2 py-1 mb-3">Delete Domain</h2>
                  <p className="text-sm text-start  text-dark-blue-2 opacity-80 py-1">The following domains will be permanently deleted along with related aliases.</p>
                  <p className="text-sm text-start  text-dark-blue-2 opacity-80 py-1">If you would like to use a domain on another project, consider moving it instead.</p>
                ...
                <div className=" py-3 px-5">
                    <p className="text-sm text-start text-gray-600 w-full"><span>No aliases will be deleted</span></p>
                </div>
